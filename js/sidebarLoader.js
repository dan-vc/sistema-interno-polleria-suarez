document.addEventListener('DOMContentLoaded', () => {
    ...
    const sidebarElement = document.querySelector(".sidebar[data-page]");

    const sidebarTemplate = `
        <img src="img/LOGO.png" alt="Logo">

        <nav>
            <a href="dashboard.html" class="nav-link ${sidebarElement.dataset.page === 'dashboard' ? 'active' : ''}">
            ...
            <a href="orders.html" class="nav-link ${sidebarElement.dataset.page === 'orders' ? 'active' : ''}">
                <svg xmlns="http://www.w3.org/2000/svg"
            ...
            <a href="inventory.html" class="nav-link ${sidebarElement.dataset.page === 'inventory' ? 'active' : ''}">
                <svg xmlns="http://www.w3.org/2000/svg"
            ...
            <a href="accounting.html" class="nav-link ${sidebarElement.dataset.page === 'accounting' ? 'active' : ''}">
                <svg xmlns="http://www.w3.org/2000/svg"
            ...
            <a href="settings.html" class="nav-link ${sidebarElement.dataset.page === 'settings' ? 'active' : ''}">
                <svg xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                    <path
        ...
        <a href="index.html" class="btn btn-red">Cerrar sesión</a>
    `
